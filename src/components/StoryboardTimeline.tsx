...
export const StoryboardTimeline: React.FC<StoryboardTimelineProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Header bar with Global Actions - Clean 2-Tier Structured Layout */}
      <div className="bg-gray-900/90 rounded-2xl p-4 border border-gray-800 flex flex-col gap-3.5 glass-panel shadow-xl">
        {/* Tier 1: Title and Main Batch Voice & Script Import Actions */}
        <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-gray-800/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm md:text-base font-bold text-white flex items-center gap-2">
                <span>Biên Tập Lộ Trình Phân Cảnh</span>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-pink-600 to-indigo-600 hover:from-pink-500 hover:to-indigo-500 text-white text-xs font-bold shadow-md shadow-pink-500/20 disabled:opacity-50 transition-all active:scale-95 cursor-pointer"
            ...
            >
              {isBatchSynthesizing ? (
                ...
                <>
                  ...
                  <span>Ghép giọng AI toàn cảnh</span>
                </>
              )}
            </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-bold shadow-md shadow-emerald-500/20 disabled:opacity-50 transition-all active:scale-95 border border-emerald-400/30 cursor-pointer"
            ...
            >
              {isTranscribingFullAudio ? (
                ...
                <>
                  ...
                  <span>🎙️ Đẩy sound toàn bài</span>
                </>
              )}
            </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-gray-800 hover:bg-gray-700 text-indigo-300 hover:text-white border border-indigo-500/30 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
        ...
        {/* Tier 2: Scene Templates, Global Quick Controls & Sync Button */}
        <div className="flex flex-wrap items-center justify-between gap-2.5">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-purple-950/60 hover:bg-purple-900/60 text-purple-300 hover:text-white border border-purple-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-amber-950/60 hover:bg-amber-900/60 text-amber-300 hover:text-white border border-amber-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-cyan-950/60 hover:bg-cyan-900/60 text-cyan-300 hover:text-white border border-cyan-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-emerald-950/60 hover:bg-emerald-900/60 text-emerald-300 hover:text-white border border-emerald-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-rose-950/60 hover:bg-rose-900/60 text-rose-300 hover:text-white border border-rose-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-sky-950/60 hover:bg-sky-900/60 text-sky-300 hover:text-white border border-sky-500/40 text-xs font-semibold transition-all active:scale-95 cursor-pointer"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-200 hover:text-white border border-gray-700 text-xs font-semibold transition-all cursor-pointer"
            >
              <Plus className="w-3.5 h-3.5" />
              <span>Cảnh Thường</span>
            </button>
          </div>

          {/* Global Operations: Tự động đổi ảnh AI, 1-Click Tắt Chữ Ngang, và Cập nhật Video Player */}
          <div className="flex flex-wrap items-center gap-2">
            ...
            {project.scenes.some((sc) => !sc.mediaUrl || sc.mediaUrl.includes('photo-1451187580459-43490279c0fa')) && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-pink-600 hover:from-amber-400 hover:to-pink-500 text-white text-xs font-black transition-all shadow-md shadow-amber-500/20 active:scale-95 animate-pulse cursor-pointer"
              ...
              >
                ...
                <span>
                  {isAutoFixingDefaultMedia
                    ? 'Đang đổi...'
                    : `✨ Đổi Ảnh (${project.scenes.filter((sc) => !sc.mediaUrl || sc.mediaUrl.includes('photo-1451187580459-43490279c0fa')).length})`}
                </span>
              </button>
            )}
            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  <span>{allHidden ? 'Đã Tắt Chữ Ngang Dưới' : 'Đang Hiện Chữ Ngang Dưới'}</span>
                </button>
              );
            })()}
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs font-black shadow-md shadow-cyan-500/25 transition-all active:scale-95 cursor-pointer"
